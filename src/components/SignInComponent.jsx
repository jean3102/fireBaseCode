      ...
      <Container component="main" maxWidth="xs">
        ...
        >
          ...
          <Box component="form" onSubmit={handleSubmit} noValidate sx={{ mt: 1 }}>
            ...
            <Grid container>
              <Grid item xs>
                <span style={{ color: '#1976d2', cursor: 'pointer' }} onClick={restPassword} >Forgot password?</span>
              </Grid>
              <Grid item>
                {"Don't have an account? "}
                <span style={{ color: '#1976d2', cursor: 'pointer' }} onClick={() => navigate('/register')}>Sign Up</span>
              </Grid>
            </Grid>
          </Box>
        </Box>
